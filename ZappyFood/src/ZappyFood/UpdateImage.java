...
public class UpdateImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     ProductBean e=new ProductBean();
		...
		MyDao m=new MyDao();
		int x=m.updateImage(e);
		
		if(x!=0)
	    {
			ArrayList<ProductBean> list= m.viewProduct();
	    javax.servlet.RequestDispatcher rd=request.getRequestDispatcher("View.jsp");
	  
	    request.setAttribute("msg","<h1>Image updated Successfully...</h1>");
	    ...
	    rd.forward(request, response);
	    	...
	    	out.println("<h1>Image Not Updated</h1>");
